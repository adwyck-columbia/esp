...
int main(int argc, char *argv[])
{
   ...
   // write_sprint(sprint_tile_1, 1, 5, 15); //SPRINT_1
    ...
    //write_sprint(sprint_tile_3, 1, 5, 15); //SPRINT_3
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started F1\n");
    #endif
   ...
   // write_sprint_cfg(router_tile_4, 15, 5, 1);    // duration=15, tokens=5, enable=1 //pranavi
    ...
    //write_sprint(sprint_tile_4, 1, 5, 15); //SPRINT_4
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started V1\n");
    #endif
    ...
    //write_sprint(sprint_tile_5, 1, 5, 15); //SPRINT_5
    write_config1(espdev, activity_const, random_rate_const, 0, 0);
    #ifdef DEBUG
    printf("Started F2\n");
    #endif
...
///////////////////////////////////////////////////////////////////////////////////////////
   ...
   // write_sprint(sprint_tile_0, 1, 5, 15); //SPRINT
    //write_sprint(sprint_tile_0, 1, 5, 15); //SPRINT_6
